            ...
            .on("click", function () {
              n(this).next(".sub-menu").slideToggle(),
                ...
                n(this).siblings("ul").hasClass("open") &&
                  n(this).parents("li").eq(1).addClass("active");
            }))
        : e.addClass("dropdown"),
    ...
    f.fn.extend({
      easyResponsiveTabs: function (l) {
        var c = (l = f.extend(
          ...
          h = !(!window.history || !history.replaceState);
          ...
          this.each(function () {
            ...
            n
              ...
              n
                ...
                .addClass(l.tabidentify),
              "vertical" == c &&
                n.addClass("resp-vtabs").addClass(l.tabidentify),
              1 == u && n.css({ width: "100%", margin: "0px" }),
              "accordion" == c &&
                (n.addClass("resp-easy-accordion").addClass(l.tabidentify),
            ...
            "" == p ||
              ...
              !0 === l.closed ||
                ...
                (f(n.find(".resp-accordion." + l.tabidentify)[a])
                  .addClass("resp-tab-active")
                  .css({
                ...
                f(n.find(".resp-tab-content." + l.tabidentify)[a])
        ...
        this.is("dragging") &&
          ...
          this.settings.loop
            ...
            : ((i = this.settings.rtl
              ...
              (s.x = Math.max(Math.min(s.x, i + e), n + e))),
          ...
          "prepared.owl.carousel": n.proxy(function (t) {
            ...
            this.owl.options.thumbImage
              ? t.namespace &&
                this.owl.options.thumbs &&
                this.owl.options.thumbImage &&
                ((e = n(t.content).find("img")), this._thumbcontent.push(e))
              : void 0 !==
                  n(t.content).find("[data-thumb]").attr("data-thumb") &&
          ...
          n(this._thumbcontent._thumbcontainer).on(
            ...
            n.proxy(function (t) {
              this._identifier = n(t.target)
                ...
                .data("slider-id");
              var e = (
                n(t.target).parent().is(this._thumbcontent._thumbcontainer)
                  ? n(t.target)
                  : n(t.target).closest("." + i.thumbItemClass)
              ).index();
              i.thumbsPrerendered
    ...
    function (t, $, P) {
      ...
      (function (t) {
        ...
        var c =
          ...
          g = !1;
        function y(t) {
          (f = o.window.innerWidth || document.documentElement.clientWidth),
            (m = r
              ? (!d &&
                  document.body &&
        ...
        y(),
          o.window.addEventListener("resize", y),
          o.window.addEventListener("orientationchange", y),
          o.window.addEventListener("load", y),
              ...
              t &&
                ...
                (0, n.default)(function () {
                  t.forEach(function (t) {
                    t.target &&
                      t.target.jarallax &&
                      (h || t.target.jarallax.onResize(), (g = !0));
                  });
                });
            }),
          S = 0,
            ...
            (x = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (o.position = i.image.position),
                    i.css(i.image.$item, o),
                    i.image.$container.appendChild(i.image.$item),
                    i.onResize(),
                    i.onScroll(!0),
                    i.options.automaticResize && k && k.observe(i.$item),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  l.options.elementInViewport &&
                    (h = l.options.elementInViewport.getBoundingClientRect()),
                    ...
                    (t || l.isElementInViewport) &&
                      ...
                      ("opacity" !== l.options.type &&
                        ...
                        ((p.transform = "translate3d(0,0,0)"), (p.opacity = t)),
          ...
          for (
            ...
            if (
              ("object" === (void 0 === i ? "undefined" : l(i)) || void 0 === i
                ? t[s].jarallax || (t[s].jarallax = new E(t[s], i))
                : t[s].jarallax &&
    ...
    function (t, e, i) {
      ...
      var n = i(15),
        ...
        i =
          ...
          clearTimeout;
      Function.prototype.bind && ((o = o.bind(n)), (i = i.bind(n))),
        ((t.exports = o).cancel = i);
    },
    function (e, t, i) {
      "use strict";
      (function (t) {
                    ...
                    "vimeo" === o.type &&
                      ...
                      (n.onreadystatechange = function () {
                        ...
                        4 === this.readyState &&
                          ...
                          (o.videoImage = t[0].thumbnail_large),
                          e(o.videoImage));
                      }),
                      n.send(),
                      (n = null)));
          ...
          t.prototype.coverImage = function () {
            ...
            return (
              s &&
                ...
                r &&
                ("IFRAME" === r || "VIDEO" === r) &&
                ((e = ((t = s.image.height) * o.image.width) / o.image.height),
                (i = (s.container.width - e) / 2),
                (n = s.image.marginTop),
                s.container.width > e &&
                  ((t =
                    ((e = s.container.width) * o.image.height) / o.image.width),
                  (i = 0),
                  (n += (s.image.height - t) / 2)),
                "IFRAME" === r && ((t += 400), (n -= 200)),
                o.css(o.$video, {
                  width: e + "px",
                  marginLeft: i + "px",
                  height: t + "px",
    ...
    (u.prototype.extend = function (t, e) {
      ...
      (i =
        ...
        ((c.prototype.get = function (t) {
          for (
            var e, i, n = (e = 0), o = (i = this.keys).length;
            e < o;
            n = ++e
          )
        ...
        (c.prototype.set = function (t, e) {
          for (
            var i, n, o = (i = 0), s = (n = this.keys).length;
            i < s;
            o = ++i
          )
      ...
      (this.WOW =
        ...
        (s.prototype.start = function () {
          ...
          if (
            ...
            (this.all = function () {
              for (
                var t, e = [], i = 0, n = (t = this.boxes).length;
                i < n;
                i++
              )
                (o = t[i]), e.push(o);
          ...
          return (
            ...
            this.config.live
              ? new n(
                  ((r = this),
                  function (t) {
                    for (var o, s, e = [], i = 0, n = t.length; i < n; i++)
                      (s = t[i]),
                        e.push(
                          function () {
                            for (
                              var t,
                                e = [],
                                i = 0,
                                n = (t = s.addedNodes || []).length;
                              i < n;
                              i++
                            )
                              (o = t[i]), e.push(this.doSync(o));
                            return e;
                          }.call(r)
                        );
                    return e;
        ...
        (s.prototype.resetStyle = function () {
          for (var t, e, i = [], n = 0, o = (e = this.boxes).length; n < o; n++)
          ...
          for (s in t)
            (r = t[s]),
              ...
              e.push(
                function () {
                  for (
                    var t, e = [], i = 0, n = (t = this.vendors).length;
                    i < n;
                    i++
                  )
                    (a = t[i]),
                      e.push(
                        (o["" + a + s.charAt(0).toUpperCase() + s.substr(1)] =
                          r)
                      );
                  return e;
                }.call(this)
        ...
        (s.prototype.vendorCSS = function (t, e) {
          for (
            var i,
              n,
              o,
              s = (n = l(t)).getPropertyCSSValue(e),
              r = 0,
              a = (i = this.vendors).length;
            r < a;
            r++
          )
            (o = i[r]), (s = s || n.getPropertyCSSValue("-" + o + "-" + e));
          return s;
        }),
  ...
  Prism = (function (l) {
      ...
      $ = {
        ...
        util: {
          encode: function (t) {
            return t instanceof P
              ? new P(t.type, $.util.encode(t.content), t.alias)
              : Array.isArray(t)
              ? t.map($.util.encode)
              : t
                  .replace(/&/g, "&amp;")
          ...
          clone: function i(t, n) {
            ...
            switch (((n = n || {}), s)) {
              case "Object":
                if (((e = $.util.objId(t)), n[e])) return n[e];
                for (var r in ((o = {}), (n[e] = o), t))
                  t.hasOwnProperty(r) && (o[r] = i(t[r], n));
                return o;
              case "Array":
                return (
                  (e = $.util.objId(t)),
        ...
        languages: {
          ...
          insertBefore: function (i, t, e, n) {
            ...
            return (
              (n[i] = r),
              $.languages.DFS($.languages, function (t, e) {
                e === l && t != i && (this[t] = r);
              }),
              r
            );
          ...
          DFS: function t(e, i, n, o) {
            ...
            for (s in e)
              e.hasOwnProperty(s) &&
                (i.call(e, s, e[s], n || s),
                (r = e[s]),
                "Object" !== (a = $.util.type(r)) || o[l(r)]
                  ? "Array" !== a || o[l(r)] || ((o[l(r)] = !0), t(r, i, s, o))
                  : ((o[l(r)] = !0), t(r, i, null, o)));
          },
        },
        plugins: {},
        highlightAll: function (t, e) {
          $.highlightAllUnder(document, t, e);
        },
        highlightAllUnder: function (t, e, i) {
          ...
          $.hooks.run("before-highlightall", n);
          for (
            var o, s = n.elements || t.querySelectorAll(n.selector), r = 0;
            (o = s[r++]);

          )
            $.highlightElement(o, !0 === e, n.callback);
        },
        highlightElement: function (t, e, i) {
          for (var n, o = "none", s = t; s && !c.test(s.className); )
            s = s.parentNode;
          s &&
            ((o = (s.className.match(c) || [, "none"])[1].toLowerCase()),
            (n = $.languages[o])),
            (t.className =
          ...
          var a = { element: t, language: o, grammar: n, code: t.textContent };
          $.hooks.run("before-sanity-check", a),
            a.code
              ? ($.hooks.run("before-highlight", a),
                a.grammar
                  ? e && l.Worker
                    ? (((e = new Worker($.filename)).onmessage = function (t) {
                        r(t.data);
                      }),
                      e.postMessage(
                        JSON.stringify({
                    ...
                    : r($.highlight(a.code, a.grammar, a.language))
                  : r($.util.encode(a.code)))
              : $.hooks.run("complete", a);
        },
        highlight: function (t, e, i) {
          i = { code: t, grammar: e, language: i };
          return (
            $.hooks.run("before-tokenize", i),
            (i.tokens = $.tokenize(i.code, i.grammar)),
            $.hooks.run("after-tokenize", i),
            P.stringify($.util.encode(i.tokens), i.language)
          );
        },
        matchGrammar: function (t, e, i, n, o, s, r) {
          for (var a in i)
            if (i.hasOwnProperty(a) && i[a]) {
              if (a == r) return;
              for (
                var l = i[a], l = "Array" === $.util.type(l) ? l : [l], c = 0;
                c < l.length;
                ++c
              ) {
                var u,
                  ...
                  if (!(b instanceof P)) {
                    if (f && y != e.length - 1) {
                      ...
                      for (
                        var w = S.index + (h ? S[1].length : 0),
                          ...
                          C = v,
                          k = e.length;
                        x < k && (C < _ || (!e[x].type && !e[x - 1].greedy));
                        ++x
                      )
                        (C += e[x].length) <= w && (++y, (v = C));
                      if (e[y] instanceof P) continue;
                      (E = x - y), (b = t.slice(v, C)), (S.index -= v);
                    } else {
                      d.lastIndex = 0;
                      var S = d.exec(b),
                        E = 1;
                    ...
                    if (S) {
                      h && (m = S[1] ? S[1].length : 0),
                        (_ = (w = S.index + m) + (S = S[0].slice(m)).length);
                      var T = b.slice(0, w),
                        A = b.slice(_),
                        b = [y, E];
                      T && (++y, (v += T.length), b.push(T));
                      T = new P(a, p ? $.tokenize(S, p) : S, g, S, f);
                      if (
                        (b.push(T),
                        A && b.push(A),
                        Array.prototype.splice.apply(e, b),
                        1 != E && $.matchGrammar(t, e, i, y, v, !0, a),
                        s)
                      )
                        break;
                    } else if (s) break;
        ...
        tokenize: function (t, e) {
          ...
          return $.matchGrammar(t, i, e, 0, 0, !1), i;
        },
        hooks: {
          all: {},
          add: function (t, e) {
    ...
    if (
      ...
      (P.stringify = function (t, e) {
        ...
        t.alias &&
          ((n = Array.isArray(t.alias) ? t.alias : [t.alias]),
          Array.prototype.push.apply(i.classes, n)),
          $.hooks.run("wrap", i);
        var n = Object.keys(i.attributes)
          .map(function (t) {
            return (
            ...
            l.addEventListener(
              ...
              function (t) {
                var e = JSON.parse(t.data),
                  ...
                  t = e.code,
                  e = e.immediateClose;
                l.postMessage($.highlight(t, $.languages[i], i)),
                  e && l.close();
              },
              !1
            )),
        ...
        return e === m || "object" == typeof e
          ? this.each(function () {
              f.data(this, "plugin_" + n) ||
                f.data(this, "plugin_" + n, new c(this, e));
            })
          ...
          ? this.each(function () {
              ...
              t instanceof c &&
                ...
                "destroy" === e && f.data(this, "plugin_" + n, null);
            })
          : void 0;
      }),
      (f[n] = function (t) {
  ...
  (function (t) {
          ...
          "string" == typeof t
            ? "open" === t
              ? ((e = a ? o.data("magnificPopup") : o[0].magnificPopup),
                ...
                (n = e.items
                  ? e.items[i]
                  : ((n = o), e.delegate && (n = n.find(e.delegate)), n.eq(i))),
          ...
          if ((C(), t.src)) {
            ...
            return (
              o.length
                ? ((i = o[0].parentNode) &&
                    i.tagName &&
                    (S || ((k = n.hiddenClass), (S = d(k)), (k = "mfp-" + k)),
        ...
        getImage: function (t, e) {
          ...
          return (
            a.length &&
              ...
              (t.img = c(i).on("load.mfploader", o).on("error.mfploader", s)),
              (i.src = t.src),
    ...
    c.magnificPopup.registerModule("gallery", {
      ...
      proto: {
          ...
          return (
            ...
            !(!s || !s.enabled) &&
              ...
              u(v + t, function (t, e, i, n) {
                ...
                i.counter = 1 < o ? M(s.tCounter, n.index, o) : "";
              }),
        ...
        next: function () {
          (f.direction = !0), (f.index = F(f.index + 1)), f.updateItemHTML();
        },
        prev: function () {
          (f.direction = !1), (f.index = F(f.index - 1)), f.updateItemHTML();
        },
        goTo: function (t) {
  ...
  (function () {
    ...
    function i(t) {
      (this.element = t),
        ...
        (n += 1),
        h.windowContext ||
          ((h.windowContext = !0), (h.windowContext = new i(window))),
          ...
          for (s in this.waypoints[e]) {
            ...
            l.element !== l.element.window &&
              ...
              !p && a && c
                ...
                : ((!p && u) || (p && r.oldScroll >= l.triggerPoint)) &&
